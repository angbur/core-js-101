...
describe('02-numbers-tasks', () => {
  ...
  it.optional('getAverage should return an average of two numbers', () => {
    ...
    assert.equal(tasks.getAverage(Number.MAX_SAFE_INTEGER - 2, Number.MAX_SAFE_INTEGER), Number.MAX_SAFE_INTEGER - 1);
    assert.equal(tasks.getAverage(Number.MAX_SAFE_INTEGER, -Number.MAX_SAFE_INTEGER / 2), Number.MAX_SAFE_INTEGER / 4);
  });
